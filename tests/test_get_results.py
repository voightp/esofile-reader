...
TEST_SIMPLE_IP_DF = pd.DataFrame(
    [
        [4.44599391, 1.76934089, 0.004855573, 66.467306],
        [4.280304696, 3.003208279, 0.004860482, 66.191490],
        [4.059385744, 5.7636721, 0.005461099, 69.779761],
        [4.394446155, 7.66427499, 0.005840664, 73.006558],
        [4.44599391, 10.3586889, 0.007228851, 75.777528],
        [3.99495105, 11.431493266, 0.007842664, 77.863505],
        [4.44599391, 11.15882263, 0.009539482, 79.101427],
        [4.252689827, 9.033478290, 0.009332843, 78.231286],
        [4.194698603, 6.694115644, 0.007949586, 75.475210],
        [4.44599391, 3.898493763, 0.007626202, 72.458451],
        [4.194698603, 2.6608011300, 0.006508911, 69.059797],
        [4.252689827, 1.6200904122, 0.005512091, 65.591278],
    ],
    columns=pd.MultiIndex.from_tuples(
        [
            ("BLOCK3:ZONE1", ""),
