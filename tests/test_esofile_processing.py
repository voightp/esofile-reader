        ...
        with open(self.body_pth, "r") as f:
            ...
            self.assertEqual(raw_outputs[0]["timestep"][7],
                             [15.65, 14.3, 14.15, 14.0, 12.8, 11.6, 10.899999999999999, 10.2, 11.05, 11.9,
                              ...
                              28.0, 28.6, 29.1, 29.6, 30.200000000000004, 30.8, 31.05, 31.3,
                              30.75, 30.2, 29.6, 29.0, 28.7, 28.4, 27.45, 26.5, 25.7, 24.9,
                              24.049999999999998, 23.2, 22.25, 21.3, 20.25, 19.2, 18.1, 17.0, 16.05,
                              15.1, 14.3, 13.5, 12.95, 12.4, 12.100000000000002, 11.8, 11.600000000000002,
                              11.4, 11.15, 10.9, 11.45, 12.0, 11.9, 11.8, 12.5, 13.2,
                              13.75, 14.3, 14.75, 15.2, 15.35, 15.5, 16.55, 17.6, 17.200000000000004, 16.8,
                              16.5, 16.2, 15.5, 14.8, 15.6, 16.4, 16.299999999999998, 16.2, 15.7,
                              15.2, 14.45, 13.7, 13.05, 12.4, 11.9, 11.4, 10.850000000000002, 10.3, 10.2,
                              10.1])
            self.assertEqual(raw_outputs[0]["hourly"][8],
                             [14.975000000000002, 14.075, 12.2, 10.549999999999999,
                              11.475000000000002, 13.55, 15.525, 18.025, 21.25, 24.575,
                              26.9, 28.3, 29.35, 30.5, 31.175, 30.475, 29.3,
                              28.549999999999998, 26.975, 25.299999999999998, 23.625, 21.775,
                              19.725, 17.55, 15.575, 13.9, 12.675, 11.950000000000001, 11.5,
                              11.025, 11.725, 11.850000000000002, 12.85, 14.025, 14.975,
                              15.425, 17.075000000000004, 17.0, 16.35, 15.15, 16.0, 16.25,
                              15.45, 14.075, 12.725000000000002, 11.65, 10.575000000000001,
                              10.149999999999999])
            ...
            self.assertEqual(raw_outputs[0]["hourly"][163],
                             [np.NaN, np.NaN, np.NaN, np.NaN, np.NaN, np.NaN, np.NaN, np.NaN, np.NaN, np.NaN, np.NaN,
                              ...
                              31.703936337515786, 32.280660803461618, 32.62177706428757,
                              32.88418951192571, 33.009496155093547, 33.03911553829569,
                              32.92907267649866, 32.65682359572439, 32.31898695867979,
                              32.197143544621329, 31.872368037056775, np.NaN, np.NaN, np.NaN, np.NaN, np.NaN,
                              np.NaN])
