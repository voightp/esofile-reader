...
def preprocess_file(file_path: Union[str, Path], progress_logger: GenericLogger) -> None: ...
def process_eso_file(
    file_path: Union[str, Path], progress_logger: GenericLogger, ignore_peaks: bool = True,
) -> List[RawEsoData]: ...
