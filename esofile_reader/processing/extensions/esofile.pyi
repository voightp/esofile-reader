...
def read_header(
    eso_file: TextIO, progress_logger: BaseLogger
...
def read_file(
    file: TextIO, progress_logger: BaseLogger, ignore_peaks: bool = True
) -> List[RawEsoData]: ...
def count_lines(file_path: Union[str, Path]) -> int: ...
def preprocess_file(file_path: Union[str, Path], progress_logger: BaseLogger) -> None: ...
def process_eso_file(
    file_path: Union[str, Path], progress_logger: BaseLogger, ignore_peaks: bool = True,
) -> List[RawEsoData]: ...
